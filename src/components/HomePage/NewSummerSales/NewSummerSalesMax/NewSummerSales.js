...
export function NewSummerSalesMax() {
    ...
    useEffect(() => {
        ...
        const dotUnu = document.querySelectorAll(`.${CSS.dotUnu}`)
        ...
        dotUnu[0].style.backgroundColor = "#559137"
        dotUnu[0].style.borderColor = "#559137"
        ...
        dotUnu[0].addEventListener('click', () => {
            index = 0
        ...
        function currentDot() {
            ...
            if (index === 1) {
                dotUnu[0].style.backgroundColor = "transparent"
                dotUnu[0].style.borderColor = "#aaaa"
