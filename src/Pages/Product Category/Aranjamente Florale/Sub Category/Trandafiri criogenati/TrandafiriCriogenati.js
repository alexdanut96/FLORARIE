...
import STYLE from "./TrandafiriCriogenati.module.css"
...
import items from "../../../../../data/Aranjamente florale/Trandafiri criogenati/TrandafiriCriogenati.json"

export function TrandafiriCriogenati() {
    ...
    return (
        <div className={STYLE.container}>
            <div className={STYLE.titleContent}>
                <div className={STYLE.title}>TRANDAFIRI &nbsp;CRIOGENATI</div>
            ...
            <div className={STYLE.information}>
                <div className={STYLE.informationTitle}>Comanda Online Trandafiri Criogenati Superbe cu Livrare la Domiciliu</div>
                <div className={STYLE.informationContent}>
                    <div className={STYLE.informationContentOne}>
                        Un cadou unic si special pentru o zi speciala: trandafirul criogenat!
                    </div>
                    <div className={STYLE.informationContentTwo}>
                        <div>
                            Cum se obtin trandafirii nemuritori
                        </div>
                        <div>
                            Trandafirii nemuritori presupun uscarea florilor prin congelare. In ceea ce priveste partea tehnica, aceasta se numeste liofinozare (transformarea apei din stare lichida in stare solida). Toate procedura se realizeaza in mediu vidat.
                        </div>
                    </div>
                </div>
            </div>
