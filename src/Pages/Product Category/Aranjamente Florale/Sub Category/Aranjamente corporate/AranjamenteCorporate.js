...
import STYLE from "./AranjamenteCorporate.module.css"
...
import items from "../../../../../data/Aranjamente florale/Aranjamente corporate/AranjamenteCorporate.json"

export function AranjamenteCorporate() {
    ...
    return (
        <div className={STYLE.container}>
            <div className={STYLE.titleContent}>
                <div className={STYLE.title}>ARANJAMENTE &nbsp;CORPORATE</div>
            ...
            <div className={STYLE.information}>
                <div className={STYLE.informationTitle}>Comanda Online Aranjamente Corporate Superbe cu Livrare la Domiciliu</div>
                <div className={STYLE.informationContent}>
                    <div className={STYLE.informationContentOne}>
                        Fie că vrei să mulțumești, să urezi succes sau pur și simplu vrei o sală de întâlniri primitoare, te ajutăm noi. Colecția specială de flori corporate numără atât buchete speciale, livrate oriunde în țară, în doar două ore, cât și aranjamente florale corporate specifice compuse din flori rezistente: aranjamente pentru săli de întâlniri, recepție, birouri.
                    </div>
                    <div className={STYLE.informationContentTwo}>
                        <div>
                            Echipa noastră de specialiști te poate ajuta să iei decizia potrivită. Venim în întâmpinarea ta cu preturi competitive.
                        </div>
                        <div>
                            Alege sa faci cadouri speciale din colectia de buchete de flori corporate cât și aranjamente florale corporate!
                        </div>
                    </div>
                </div>
            </div>
