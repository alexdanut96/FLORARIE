...
import STYLE from "./BucheteDeCriniImperiali.module.css"
...
import items from "../../../../../data/Buchete flori/Buchete de crini imperiali/BucheteDeCriniImperiali.json"

export function BucheteDeCriniImperiali() {
    ...
    return (
        <div className={STYLE.container}>
            <div className={STYLE.titleContent}>
                <div className={STYLE.title}>BUCHETE &nbsp;DE &nbsp;CRINI &nbsp;IMPERIALI</div>
            ...
            <div className={STYLE.information}>
                <div className={STYLE.informationTitle}>Comanda Online Buchete de Crini Imperiali Superbe cu Livrare la Domiciliu</div>
