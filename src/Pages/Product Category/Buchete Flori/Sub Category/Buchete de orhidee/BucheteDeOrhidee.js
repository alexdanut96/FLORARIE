...
import STYLE from "./BucheteDeOrhidee.module.css"
...
import items from "../../../../../data/Buchete flori/Buchete de orhidee/BucheteDeOrhidee.json"

export function BucheteDeOrhidee() {
    ...
    return (
        <div className={STYLE.container}>
            <div className={STYLE.titleContent}>
                <div className={STYLE.title}>BUCHETE &nbsp;DE &nbsp;ORHIDEE</div>
            ...
            <div className={STYLE.information}>
                <div className={STYLE.informationTitle}>Comanda Online Buchete de Orhidee Superbe cu Livrare la Domiciliu</div>
