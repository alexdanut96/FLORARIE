...
import STYLE from "./FloriSfantaAna.module.css"
...
import items from "../../../../../data/Ocazii si Evenimente/Flori Sfanta Ana/FloriSfantaAna.json"

export function FloriSfantaAna() {
    ...
    return (
        <div className={STYLE.container}>
            <div className={STYLE.titleContent}>
                <div className={STYLE.title}>FLORI &nbsp;SFANTA &nbsp;ANA</div>
            ...
            <div className={STYLE.information}>
                <div className={STYLE.informationTitle}>Comandă Online Flori de Sfânta Ana cu Livrare la Domicili</div>
                <div className={STYLE.informationContent}>
                    <div className={STYLE.informationContentOne}>
                        Flori pentru Ana si Ioachim. Pentru cei dragi care isi serbeaza ziua onomastica in data 9 septembrie, cu ocazia Sfintilor Ioachim si Ana, alege un buchet de flori special din colectia dedicata. Ne bucuram in continuare de buchete de flori de vara, cu accente de toamna.
                    </div>
