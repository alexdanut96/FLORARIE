...
import STYLE from "./BucheteLaMultiAni.module.css"
...
import items from "../../../../../data/Ocazii si Evenimente/Buchete La Multi Ani/BucheteLaMultiAni.json"

export function BucheteLaMultiAni() {
    ...
    return (
        <div className={STYLE.container}>
            <div className={STYLE.titleContent}>
                <div className={STYLE.title}>BUCHETE &nbsp;LA &nbsp;MULTI &nbsp;ANI</div>
            ...
            <div className={STYLE.information}>
                <div className={STYLE.informationTitle}>Comandă Online Buchete La Mulți Ani cu Livrare la Domiciliu</div>
                <div className={STYLE.informationContent}>
                    <div className={STYLE.informationContentOne}>
                        Cele mai importante momente merita sarbatorite cu flori! Asa ca am creat pentru tine o colectie speciala cu flori de la multi ani pentru ca fiecare zi de nastere sa fie de neuitat!
                    </div>
                    <div className={STYLE.informationContentTwo}>

                        Alege buchete de flori de ziua de nastere si surprinde-i pe cei dragi cu flori proaspete si cadouri speciale! Colectia flori aniversari contine aranjamente si buchete de flori care spun cel mai frumos la multi ani!
                    </div>
                </div>
            </div>
