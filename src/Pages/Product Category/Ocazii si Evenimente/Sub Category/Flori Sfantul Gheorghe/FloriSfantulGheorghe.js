...
import STYLE from "./FloriSfantulGheorghe.module.css"
...
import items from "../../../../../data/Ocazii si Evenimente/Flori Sfantul Gheorghe/FloriSfantulGheorghe.json"

export function FloriSfantulGheorghe() {
    ...
    return (
        <div className={STYLE.container}>
            <div className={STYLE.titleContent}>
                <div className={STYLE.title}>FLORI &nbsp;SFANTUL &nbsp;GHEORGHE</div>
            ...
            <div className={STYLE.information}>
                <div className={STYLE.informationTitle}>Comandă Online Flori Sfântul Gheorghe cu Livrare la Domiciliu</div>
