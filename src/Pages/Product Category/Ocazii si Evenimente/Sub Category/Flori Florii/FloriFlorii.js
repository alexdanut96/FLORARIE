...
import STYLE from "./FloriFlorii.module.css"
...
import items from "../../../../../data/Ocazii si Evenimente/Flori Florii/FloriFlorii.json"

export function FloriFlorii() {
    ...
    return (
        <div className={STYLE.container}>
            <div className={STYLE.titleContent}>
                <div className={STYLE.title}>FLORI &nbsp;FLORII</div>
            ...
            <div className={STYLE.information}>
                <div className={STYLE.informationTitle}>Comandă Online Flori Florii cu Livrare la Domiciliu</div>
                <div className={STYLE.informationContent}>
                    <div className={STYLE.informationContentOne}>
                        Ce cadou ar fi mai potrivit pentru o persoana cu nume de floare, decat un buchet de flori! Acestea sunt un simbol al reinnoirii si renasterii si un mod minunat de a decora casa pentru Paste.
                    </div>
                    <div className={STYLE.informationContentTwo}>
                        Camelia, Crina, Anemona, Narcisa, toate au un buchet de flori special creat pentru a-si sarbatori ziua numelui. Fa cele mai frumoase surprize, inspira-te din colectia noastra de Florii!
                    </div>
                </div>
            </div>
