...
import STYLE from "./FloriOnomastica.module.css"
...
import items from "../../../../../data/Ocazii si Evenimente/Flori Onomastica/FloriOnomastica.json"

export function FloriOnomastica() {
    ...
    return (
        <div className={STYLE.container}>
            <div className={STYLE.titleContent}>
                <div className={STYLE.title}>FLORI &nbsp;ONOMASTICA</div>
            ...
            <div className={STYLE.information}>
                <div className={STYLE.informationTitle}>Comandă Online Flori Onomastică cu Livrare la Domiciliu</div>
