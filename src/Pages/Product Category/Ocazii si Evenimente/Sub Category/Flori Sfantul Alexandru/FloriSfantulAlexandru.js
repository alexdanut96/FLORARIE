    ...
    return (
        <div className={STYLE.container}>
            ...
            <div className={STYLE.information}>
                <div className={STYLE.informationTitle}>Comandă Online Flori de Sfântul Alexandru cu Livrare la Domiciliu</div>
                <div className={STYLE.informationContent}>
                    <div className={STYLE.informationContentOne}>
                        Ziua onomastică este la fel de importantă ca ziua de naștere. Așadar, nu uita să îți feliciți toți prietenii care poartă numele Sfântului Alexandru. Pe 30 august, este ziua lor!
                    </div>
                    <div className={STYLE.informationContentTwo}>
                        Oferă-le buchete de flori sau aranjamente și felicitări personalizate. Noi îți promitem că le vom livra rapid, în doar două ore, oriunde în țară!
                    </div>
                </div>
            </div>
