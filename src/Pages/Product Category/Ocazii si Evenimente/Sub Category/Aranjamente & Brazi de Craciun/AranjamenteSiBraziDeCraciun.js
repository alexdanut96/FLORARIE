...
import STYLE from "./AranjamenteSiBraziDeCraciun.module.css"
...
import items from "../../../../../data/Ocazii si Evenimente/Aranjamente si Brazi de Craciun/AranjamenteSiBraziDeCraciun.json"

export function AranjamenteSiBraziDeCraciun() {
    ...
    return (
        <div className={STYLE.container}>
            <div className={STYLE.titleContent}>
                <div className={STYLE.title}>ARANJAMENTE &nbsp;SI &nbsp;BRAZI &nbsp;DE &nbsp;CRACIUN</div>
            ...
            <div className={STYLE.information}>
                <div className={STYLE.informationTitle}>Comanda Online Aranjamente si Brazi de Craciun Superbe cu Livrare la Domiciliu</div>
