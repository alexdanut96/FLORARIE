...
import STYLE from "./AmUitatParola.module.css"
import { FreeDelivery } from "../../../../components/HomePage/FreeDelivery/FreeDelivery";
import { SiGmail } from "react-icons/si"
import { BsFacebook } from "react-icons/bs"
import { BsArrowLeftShort } from "react-icons/bs"

export function AmUitatParola() {
    ...
    useEffect(() => {
        ...
        const passwordBox = document.querySelectorAll(`.${STYLE.passwordBox}`)
        ...
        loginButton[0].addEventListener("click", () => {
            ...
            passwordBox[0].style.display = "block"
        ...
        loginButtonHidden[0].addEventListener("click", () => {
            ...
            passwordBox[0].style.display = "none"
            ...
            <div className={STYLE.content}>
                <div className={STYLE.loginForm}>
                    ...
                    <div className={STYLE.columnRight}>
                        ...
                        <input className={STYLE.passwordBox} type="password" placeholder="Adauga-ti parola" />
